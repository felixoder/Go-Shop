...
func handleCreateCheckoutSession(w http.ResponseWriter, r *http.Request) {
	...
	checkoutParams := &stripe.CheckoutSessionParams{
		...
		SuccessURL: stripe.String("http://go-shop-3.onrender.com/success/" + prod.ID.Hex()), // Dynamic success URL
		CancelURL:  stripe.String("http://go-shop-3.onrender.com/failure"),
	}
